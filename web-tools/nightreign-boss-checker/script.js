...
const raidRoutes = {
    ...
    // 以下の襲撃者は絞り込めない（全候補）
    "raid_harmonia": ["グラディウス(常夜)", "ナメレス", "エデレ(常夜)", "リブラ(常夜の王)", "カリゴ(常夜)", "マリス(常夜)", "フルゴール(常夜)", "グノスター(常夜)", "安寧者たち", "瓦礫の王(ストラゲス)"],
    "raid_caligo": ["グラディウス(常夜)", "ナメレス", "エデレ(常夜)", "リブラ(常夜の王)", "カリゴ(常夜)", "マリス(常夜)", "フルゴール(常夜)", "グノスター(常夜)", "安寧者たち", "瓦礫の王(ストラゲス)"],
    "raid_gradius": ["グラディウス(常夜)", "ナメレス", "エデレ(常夜)", "リブラ(常夜の王)", "カリゴ(常夜)", "マリス(常夜)", "フルゴール(常夜)", "グノスター(常夜)", "安寧者たち", "瓦礫の王(ストラゲス)"]
};

const suddenRoutes = {
    "mausoleum": ["マリス(常夜)", "カリゴ(常夜)"],
    "meteorite": ["グラディウス(常夜)", "エデレ(常夜)", "カリゴ(常夜)"],
    "frenzied_flame": ["グノスター(常夜)", "リブラ(常夜の王)"],
    "ancient_tower": ["グノスター(常夜)", "リブラ(常夜の王)"],
    "night_faction": ["グラディウス(常夜)", "マリス(常夜)", "フルゴール(常夜)"],
    "new_threat": ["エデレ(常夜)", "フルゴール(常夜)"]
};
